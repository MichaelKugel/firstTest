...
// All code inside tssgRtcRecording.js was develped by Michael Kugel (3MT, TSSG, WIT) (c) 2014
...
function handleSendChannelStateChange() {
  ...
  if (readyState == "open") {
    ...
    startRecordingAudioAndVideoChromeButton.disabled = false;

  } else {
      
    recordButton.disabled = true;
      startRecordingAudioAndVideoChromeButton.disabled = true;
